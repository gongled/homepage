...
Потому в любом случае важно убедиться, что с TLS в вашем приложении всё в порядке.
Для проверки сервисов практичнее использовать скрипт [robot-detect](https://github.com/robotattackorg/robot-detect).
